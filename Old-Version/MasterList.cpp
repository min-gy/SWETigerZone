...
/// for the sake of "competeing corners" jungle takes presedense over river.  
  ...
  Tile * createDeck(string * givendeck)
	...
	//Tile * Tile_2 = new Tile();
		...
		newTile.CenterClusterid = LastClusterId+2;
		LastClusterId += 2;
		}	
    //Tile * Tile_3 = new Tile();
		...
		{
	    	//Tile_3.tileID = "JJTJX";
		newTile.type = {2,2,2,2,2,3,2,2}; // has den
		newTile.clusterid = {LastClusterId+1,LastClusterId+1,LastClusterId+1,LastClusterId+1,LastClusterId+1,LastClusterId+2,LastClusterId+1,LastClusterId+1};
		newTile.meeple = {false,false,false,false,false,false,false,false};
		newTile.croc_count = 0;
		newTile.orientation = 0;
		newTile.Ox = 0;
		...
		newTile.Deer = 0;
		newTile.Monastery = true;
		newTile.CenterClusterid = LastClusterId+3;
		LastClusterId += 3;
		}
		else if(givendeck[x] == "TTTT-"){
		//Tile * Tile_4 = new Tile();
		//newTile.tileID = "TTTT-";
		newTile.type = {2,3,2,3,2,3,2,3};
		newTile.clusterid = {LastClusterId+1,LastClusterId+2,LastClusterId+3,LastClusterId+4,LastClusterId+5,LastClusterId+6,LastClusterId+7,LastClusterId+8};
		newTile.meeple = {false,false,false,false,false,false,false,false};	
		newTile.croc_count = 0;
		newTile.orientation = 0;
		newTile.Ox = 0;
	...
	//Tile * Tile_5 = new Tile();
		...
		{
		//newTile.tileID = "TJTJ-";
		newTile.type = {2,3,2,2,2,3,2,2};
		newTile.clusterid = {LastClusterId+1,LastClusterId+2,LastClusterId+3,LastClusterId+3,LastClusterId+3,LastClusterId+2,LastClusterId+1,LastClusterId+1};
		newTile.meeple = {false,false,false,false,false,false,false,false};
		newTile.croc_count = 0;
		newTile.orientation = 0;
		newTile.Ox = 0;
	...
	//newTile.tileID = "TJJT-";
	newTile.type = {2,3,2,2,2,2,2,3};
	newTile.clusterid = {LastClusterId+1,LastClusterId+2,LastClusterId+3,LastClusterId+3,LastClusterId+3,LastClusterId+3,LastClusterId+3,LastClusterId+2};
	newTile.meeple = {false,false,false,false,false,false,false,false};
	newTile.croc_count = 0;
	newTile.orientation = 0;
	newTile.Ox = 0;
	...
	//newTile.tileID = "TJTT-";
	newTile.type = {2,3,2,2,2,2,3,2,3};
	newTile.clusterid = {LastClusterId+1,LastClusterId+2,LastClusterId+3,LastClusterId+3,LastClusterId+3,LastClusterId+4,LastClusterId+5,LastClusterId+6};
        newTile.meeple = {false,false,false,false,false,false,false,false};	
	newTile.croc_count = 0;
	newTile.orientation = 0;
	newTile.Ox = 0;
	...
	//newTile.tileID = "LLLL-";
	newTile.type = {1,1,1,1,1,1,1,1};
	newTile.clusterid = {LastClusterId+1,LastClusterId+1,LastClusterId+1,LastClusterId+1,LastClusterId+1,LastClusterId+1,LastClusterId+1};
	newTile.meeple = {false,false,false,false,false,false,false,false};	
	newTile.croc_count = 0;
	newTile.orientation = 0;
	newTile.Ox = 0;
	...
	//newTile.tileID = "JLLL-";
	newTile.type = {2,2,2,1,1,1,1,1};
	newTile.clusterid = {LastClusterId+1,LastClusterId+1,LastClusterId+1,LastClusterId+2,LastClusterId+2,LastClusterId+2,LastClusterId+2,LastClusterId+2};
	newTile.meeple = {false,false,false,false,false,false,false,false};
	newTile.croc_count = 0;
	newTile.orientation = 0;
        newTile.Ox = 0;
	...
	//newTile.tileID = "LLJJ-";
	newTile.type = {2,1,1,1,2,2,2,2};
	newTile.clusterid = {LastClusterId+1,LastClusterId+2,LastClusterId+2,LastClusterId+2,LastClusterId+1,LastClusterId+1,LastClusterId+1,LastClusterId+1};
	newTile.meeple = {false,false,false,false,false,false,false,false};
        newTile.croc_count = 0;
	newTile.orientation = 0;
	newTile.Ox = 0;
	...
	//newTile.tileID = "JLJL-";
	newTile.type = {2,2,2,1,2,2,2,1};/////
	newTile.clusterid = {LastClusterId+1,LastClusterId+1,LastClusterId+1,LastClusterId+2,LastClusterId+3,LastClusterId+3,LastClusterId+3,LastClusterId+2};
	newTile.meeple = {false,false,false,false,false,false,false,false};
	newTile.croc_count = 0;
	newTile.orientation = 0;
	newTile.Ox = 0;
	...
	//newTile.tileID = "LJLJ-";
	newTile.type = {2,1,2,2,2,1,2,2};////
	newTile.clusterid = {LastClusterId+1,LastClusterId+2,LastClusterId+1,LastClusterId+1,LastClusterId+1,LastClusterId+3,LastClusterId+1,LastClusterId+1};
	newTile.meeple = {false,false,false,false,false,false,false,false};
	newTile.croc_count = 0;
	newTile.orientation = 0;
	newTile.Ox = 0;
	...
	//newTile.tileID = "LJJJ-";
	newTile.type = {2,1,2,2,2,2,2,2};
	newTile.clusterid = {LastClusterId+1,LastClusterId+2,LastClusterId+1,LastClusterId+1,LastClusterId+1,LastClusterId+1,LastClusterId+1,LastClusterId+1}; 
        newTile.meeple = {false,false,false,false,false,false,false,false};
	newTile.croc_count = 0;
	newTile.orientation = 0;
	newTile.Ox = 0;
	...
	//newTile.tileID = "JLLJ-";
	newTile.type = {2,2,2,1,4,1,2,2};
	newTile.clusterid = {LastClusterId+1,LastClusterId+1,LastClusterId+1,LastClusterId+2,NULL,LastClusterId+3,LastClusterId+1,LastClusterId+1};
	newTile.meeple = {false,false,false,false,false,false,false,false};
	newTile.croc_count = 0;
	newTile.orientation = 0;
	newTile.Ox = 0;
	...
	//newTile.tileID = "TLJT-";
	newTile.type = {2,3,2,1,2,2,2,3};
	newTile.clusterid = {LastClusterId+1,LastClusterId+2,LastClusterId+3,LastClusterId+4,LastClusterId+3,LastClusterId+3,LastClusterId+3,LastClusterId+2};
	newTile.meeple = {false,false,false,false,false,false,false,false};
	newTile.croc_count = 0;
	newTile.orientation = 0;
	newTile.Ox = 0;
	...
	newTile.type = {2,3,2,1,2,2,2,3}; // has boar
	newTile.clusterid = {LastClusterId+1,LastClusterId+2,LastClusterId+3,LastClusterId+4,LastClusterId+3,LastClusterId+3,LastClusterId+3,LastClusterId+2};
	newTile.meeple = {false,false,false,false,false,false,false,false};
	newTile.croc_count = 0;
	newTile.orientation = 0;
	...
	//newTile.tileID = "JLTT-";
	newTile.type = {2,2,2,1,2,3,2,3};
	newTile.clusterid = {LastClusterId+1,LastClusterId+1,LastClusterId+1,LastClusterId+2,LastClusterId+1,LastClusterId+3,LastClusterId+4,LastClusterId+3};
	newTile.meeple = {false,false,false,false,false,false,false,false};
	newTile.croc_count = 0;
	newTile.orientation = 0;
	newTile.Ox = 0;
	...
	newTile.type = {2,2,2,1,2,3,2,3}; // has ox
	newTile.clusterid = {LastClusterId+1,LastClusterId+1,LastClusterId+1,LastClusterId+2,LastClusterId+1,LastClusterId+3,LastClusterId+4,LastClusterId+3};
	newTile.meeple = {false,false,false,false,false,false,false,false};
	newTile.croc_count = 0;
	newTile.orientation = 0;
	...
	//newTile.tileID = "TLTJ-";
	newTile.type = {2,3,2,1,2,3,2,3};
	newTile.clusterid = {LastClusterId+1,LastClusterId+2,LastClusterId+3,LastClusterId+4,LastClusterId+3,LastClusterId+2,LastClusterId+1,LastClusterId+1};
	newTile.meeple = {false,false,false,false,false,false,false,false};
	newTile.croc_count = 0;
	newTile.orientation = 0;
	newTile.Ox = 0;
	...
	newTile.type = {2,3,2,1,2,3,2,3}; // has deer	
	newTile.clusterid = {LastClusterId+1,LastClusterId+2,LastClusterId+3,LastClusterId+4,LastClusterId+3,LastClusterId+2,LastClusterId+1,LastClusterId+1};
	newTile.meeple = {false,false,false,false,false,false,false,false};
	newTile.croc_count = 0;
	newTile.orientation = 0;
	...
	//newTile.tileID = "TLLL-";
	newTile.type = {2,3,2,1,1,1,1,1};
	newTile.clusterid = {LastClusterId+1,LastClusterId+2,LastClusterId+3,LastClusterId+4,LastClusterId+4,LastClusterId+4,LastClusterId+4,LastClusterId+4};
	newTile.meeple = {false,false,false,false,false,false,false,false};
	newTile.croc_count = 0;
	newTile.orientation = 0;
	newTile.Ox = 0;
	...
	//newTile.tileID = "TLTT-";
	newTile.type = {2,3,2,1,2,2,2,3};
	newTile.clusterid = {LastClusterId+1,LastClusterId+2,LastClusterId+3,LastClusterId+4,LastClusterId+3,LastClusterId+5,LastClusterId+6,LastClusterId+7};
	newTile.meeple = {false,false,false,false,false,false,false,false};
	newTile.croc_count = 0;
	newTile.orientation = 0;
	newTile.Ox = 0;
	...
	//newTile.tileID = "TLLT-";
	newTile.type = {2,3,2,1,1,1,2,3};
	newTile.clusterid = {LastClusterId+1,LastClusterId+2,LastClusterId+3,LastClusterId+4,LastClusterId+4,LastClusterId+4,LastClusterId+3,LastClusterId+2};
	newTile.meeple = {false,false,false,false,false,false,false,false};
	newTile.croc_count = 0;
	newTile.orientation = 0;
	newTile.Ox = 0;
	...
	//newTile.tileID = "TLLTB";
        newTile.type = {2,3,2,1,1,1,2,3}; // has ox
	newTile.clusterid = {LastClusterId+1,LastClusterId+2,LastClusterId+3,LastClusterId+4,LastClusterId+4,LastClusterId+4,LastClusterId+3,LastClusterId+2};
	newTile.meeple = {false,false,false,false,false,false,false,false};
	newTile.croc_count = 0;
	newTile.orientation = 0;
	...
	vector<int>xx;
	//xx = {2,1,2,2,2,3,2,2}; // has deer
	//newTile.type = xx;
	newTile.type = {2,1,2,2,2,3,2,2};
	newTile.clusterid = {LastClusterId+1,LastClusterId+2,LastClusterId+3,LastClusterId+3,LastClusterId+3,LastClusterId+4,LastClusterId+1,LastClusterId+1};
	//newTile.clusterid = yy;
	newTile.meeple = {false,false, false, false, false, false, false, false};
	newTile.croc_count = 0;
	newTile.orientation = 0;
	newTile.Ox = 0;
	...
	Tile_4.clusterid{1,2,3,4,5,6,7,8});
	...
	Tile_5.clusterid{1,2,3,3,3,2,1,1});
	...
	Tile_6.clusterid{1,2,3,3,3,3,3,2});
	...
	Tile_7.clusterid{1,2,3,3,3,4,5,6});
	...
	Tile_15.clusterid{1,2,3,4,3,3,3,2});
	...
	Tile_16.clusterid{1,2,3,4,3,3,3,2});
	...
	Tile_22.clusterid{1,2,3,4,3,5,6,7});
	...
	Tile_23.clusterid{1,2,3,4,3,5,6,7});
	...
	Tile_28.meeple {false,false,false,false,false,false,false,false});
