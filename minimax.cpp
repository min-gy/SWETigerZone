...
int *MinMoveDecision(tile _TileGrid[153][153], int x, int y, int z, int moveNum, vector<tile> temp);
int *MaxMoveDecision(tile _TileGrid[153][153], int x, int y, int z, int moveNum, vector<tile> temp);
...
void componentsCheck(int options[4], tile _TileGrid[153][153], int x, int y);
...
int *MiniMaxDecision(tile _TileGrid[153][153], int moveNum, tile t, vector<tile> temp) {
	...
	//update meeplecount?
	//updateScore(_TileGrid, x, y, t, z, m);
	return bestmoves;
}
		...
		for(int m = 0; m<4; m++){
						...
						if(left == true){
							...
							if(tempTile2.type[6] == tempTile1.type[a] && tempTile2.type[5] == tempTile1.type[b] && tempTile2.type[4] == tempTile1.type[c]){
								...
								if(tempTile2.type[0] == tempTile1.type[d] && tempTile2.type[1] == tempTile1.type[e] && tempTile2.type[2] == tempTile1.type[f]){
									...
									if(tempTile2.type[0] == tempTile1.type[j] && tempTile2.type[7] == tempTile1.type[k] && tempTile2.type[6] == tempTile1.type[l]){
										tempTile2 = _TileGrid[x][y-1];
										if(tempTile2.type[2] == tempTile1.type[g] && tempTile2.type[3] == tempTile1.type[h] && tempTile2.type[4] == tempTile1.type[i]){
			...
			if(right == true){
				if(left == true){
					...
					if(tempTile2.type[0] == tempTile1.type[j] && tempTile2.type[7] == tempTile1.type[k] && tempTile2.type[6] == tempTile1.type[l]){
						tempTile2 = _TileGrid[x][y-1];
						if(tempTile2.type[2] == tempTile1.type[d] && tempTile2.type[3] == tempTile1.type[e] && tempTile2.type[4] == tempTile1.type[f]){
							movelist.push_back(x); /*x*/
							movelist.push_back(y); /*y*/
							movelist.push_back(z); /*z*/
						}
...
int tigerLocation(tile _TileGrid[153][153], int x, int y, int z, int moveNum){
	int options[4];
	componentsCheck(options, _TileGrid, x, y);
